...
/**
 * Sample application demonstrating {@link OldRXTextField}.
 */
public class OldRXTextFieldDemo extends Application {

    @Override
    public void start(Stage primaryStage) {
        OldRXTextField userName = new OldRXTextField("userName");
        ...
        primaryStage.setTitle("OldRXTextField Demo");
        primaryStage.show();
    }
