...
/**
 * Parallel regression demo for ControlsFX {@link CustomTextField}, mirroring
 * {@code RXTextFieldRegressionDemo} so the two implementations can be compared side by side.
 */
public class CustomTextFieldRegressionDemo extends Application {
    ...
    public void start(Stage stage) {
        ...
        root.getChildren().addAll(
                ...
                createGridPaneCheck(),
                new Label("2. Long text clipping: text must stop before the red right pane"),
                createLongTextCheck(),
        ...
        scene.getStylesheets().add(getClass().getResource("custom-text-field-regression-demo.css").toExternalForm());
        stage.setScene(scene);
        stage.setTitle("ControlsFX CustomTextField regression checks");
        stage.show();
    }
    ...
    private static GridPane createGridPaneCheck() {
        ...
        CustomTextField field = baseField("GridPane 100px column");
    ...
    private static CustomTextField createLongTextCheck() {
        CustomTextField field = baseField("a".repeat(220));
    ...
    private static CustomTextField createRtlCheck() {
        CustomTextField field = baseField("RTL abc 123");
        field.setPrefWidth(520);
    ...
    private static VBox createMouseHitCheck() {
        CustomTextField field = baseField("0123456789 abcdefghijklmnopqrstuvwxyz");
        field.setPrefWidth(520);
        field.setLeft(iconNode());
    ...
    private static CustomTextField createPromptFillCheck() {
        CustomTextField field = baseField("");
        field.setPrefWidth(520);
    ...
    private static HBox createDetachCheck() {
        CustomTextField field = baseField("detach check");
        ...
        Button replaceSkin = new Button("setSkin(null) -> default skin");
        replaceSkin.setOnAction(event -> field.setSkin(null));
    ...
    private static CustomTextField baseField(String text) {
