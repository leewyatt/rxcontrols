...
public class RXDrawerEvent extends Event {
     ...
     */
    public static final EventType<RXDrawerEvent> OPENING = new EventType<>(ANY, "RX_DRAWER_OPENING");

    /**
     * Fired when an open slide has fully completed.
     */
    public static final EventType<RXDrawerEvent> OPENED = new EventType<>(ANY, "RX_DRAWER_OPENED");

    /**
     * Fired before any close proceeds; {@link Event#consume() consuming} it aborts
     * the close.
     */
    public static final EventType<RXDrawerEvent> CLOSE_REQUEST = new EventType<>(ANY, "RX_DRAWER_CLOSE_REQUEST");

    /**
     * Fired when a close slide starts (the close was not vetoed).
     */
    public static final EventType<RXDrawerEvent> CLOSING = new EventType<>(ANY, "RX_DRAWER_CLOSING");

    /**
     * Fired when a close slide has fully completed.
     */
    public static final EventType<RXDrawerEvent> CLOSED = new EventType<>(ANY, "RX_DRAWER_CLOSED");
