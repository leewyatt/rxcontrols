...
/**
 * Immutable metadata for one section of an {@link RXTileView}, derived from the
 * items and the {@link RXTileView#sectionKeyFactoryProperty() sectionKeyFactory}
 * and published through {@link RXTileView#sectionsProperty()}.
 *
 ...
 * in {@link RXTileView#getItems()} and can be sliced with
 ...
 */
public record RXTileSection(Object key, int sectionIndex, int firstItemIndex, int itemCount) {
