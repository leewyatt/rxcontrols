 ...
 */
public class RXIntegerField extends RXTextField {
    ...
    /**
     * Creates an empty integer field.
     */
    ...
    /**
     * Creates an integer field with an initial value.
     *
     * @param initialValue the initial value, or {@code null} for an empty field
     */
    public RXIntegerField(Integer initialValue) {
