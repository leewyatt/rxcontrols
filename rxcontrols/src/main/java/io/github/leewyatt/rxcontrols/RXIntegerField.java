 ...
 * <p>
 * User edits reject the decimal point. Programmatic writes go through the
 * same integer domain check: values such as {@code 1.0} normalize to
 * {@code 1}, while values such as {@code 1.5} are rejected.
 *
 * @see RXNumberField
 */
