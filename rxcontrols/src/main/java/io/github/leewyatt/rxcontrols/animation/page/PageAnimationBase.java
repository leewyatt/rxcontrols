...
/**
 * Base class for page animations that provides a {@code finishAction} template.
 *
 ...
 * the same visual result. Subclasses should also register the playing animation
 * via {@link #setCurrentAnimation(Animation)} so {@link #jumpToEnd()} can stop it.</p>
 */
public abstract class PageAnimationBase implements PageAnimation {
